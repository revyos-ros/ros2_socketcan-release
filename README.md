## ros2_socketcan (humble) - 1.3.0-2

The packages in the `ros2_socketcan` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble ros2_socketcan --override-release-repository-push-url git@github.com:revyos-ros/ros2_socketcan-release.git` on `Fri, 29 Nov 2024 07:14:43 -0000`
...
## ros2_socketcan (jazzy) - 1.3.0-2

The packages in the `ros2_socketcan` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy ros2_socketcan --override-release-repository-push-url git@github.com:revyos-ros/ros2_socketcan-release.git` on `Fri, 27 Sep 2024 05:16:34 -0000`
